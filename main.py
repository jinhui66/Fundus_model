...
from Dataset import EyesDataset, TransformedSubset
...
def k_fold_cross_validation(device, eyes_dataset, epochs, k_fold=5,
    ...
    train_metric = Metric_Manager()
    valid_metric = Metric_Manager()
    ...
    # for fold, (train_idx, val_idx) in enumerate(skf.split(eyes_dataset, labels), 1):
        ...
        model = EyeNet(num_classes=7).to(device)
...
if __name__ == '__main__':
    ...
    # 初始化自定义数据集
    dataset = EyesDataset(csv_file=args.csv_file_path,
